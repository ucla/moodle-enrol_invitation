...
$string['remotesubjfield'] = 'Remote subject area field';
$string['remotesubjfield_desc'] = 'The name of the field in the remote table that we are using to determine special conditions for roles that may differ based on the subject area of the course.';
