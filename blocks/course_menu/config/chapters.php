...
<div class="showHideCont">
    <a class="showHide chapters minus" id="hide-1" href="#" onclick="section_hide(this, 'div_chapters'); return false;">
        <?php echo get_string('hide', $this->blockname) ?>
    </a>
    <a class="showHide chapters plus" id="show-1" href="#" onclick="section_show(this, 'div_chapters'); return false;" style="display: none">
...
<div id="div_chapters">
    <div id="chapEnableContainer">
        <div class="expandableTreeTd">
            <a href="" onclick="changeEnableChap(); return false" class="enableDisable">
    ...
    <div id="subChapEnableContainer" <?php if (!$this->config->chapEnable) echo 'style="display: none"' ?>>
        <div class="expandableTreeTd">
            <a href="" onclick="callEnableSubChap(); return false" class="enableDisable">
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <button type="submit" onclick="changeChapNo(); return false;">
                            <?php echo get_string('change', $this->blockname) ?>
                        </button>
                        <br /><br />
                        <button type="submit" onclick="defaultGroupingClicked(); return false;">
                ...
                <tr>
                    <td id="subChaptersNumber" <?php if (!$this->config->subChapEnable) echo 'style="display: none"' ?>>
                        ...
                        <input type="text" name="" id="subChaptersCount"
                            ...
                            onkeypress="return doneEditingSubChapNo(event);" />
                    </td>
                </tr>
                <tr>
...
// function ----------------------------------------
function changeEnableChap()
{
	var enabInput = $("id_config_chapEnable");
    var img = $("img_config_chapEnable");
...
{
	var enabInput = $("id_config_subChapEnable");
	var img = $("img_config_subChapEnable");
	if (enabInput.value == 1) {
		enabInput.value = 0;
...
function defaultGroupingClicked()
{
...
//function ----------------------------------------
function doneEditingSubChapNo(event)
{
...
function changeSubChapNo(changeInput)
{
	...
	var newValue = parseInt($("subChaptersCount").value);
	if ((!IsNumeric(newValue)) || (newValue < chapters.length) || (newValue > sectionNames.length)) {
		...
		if (confirm(otherInfo.txt.warningsubchapnochange)) {
            ...
            $("id_config_subChaptersCount").value = newValue;
...
// function ----------------------------------------
function changeChapNo()
{
	var newValue = parseInt($("chaptersCount").value);
    if 	((!IsNumeric(newValue)) || (newValue < 1) || (newValue > sectionNames.length) || (config.subChapEnable == 1 && newValue > config.subChaptersCount)) {
		...
		if (confirm(otherInfo.txt.warningchapnochange)) {
            ...
            $("id_config_chaptersCount").value = newValue;
		}
	}
}
// --- (end) chapters ------------------------------------------------------------------------------ //
