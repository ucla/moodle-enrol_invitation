...
$autogenerated_content = $course_preferences->get_preference('autogenerated_content');
...
$modify_coursemenu_form = new ucla_modify_coursemenu_form(
    ...
    array(
            ...
            'autogenerated_content' => $autogenerated_content,
        ),
    'post',
    '',
...
if ($modify_coursemenu_form->is_cancelled()) {
    ...
    $course_preferences->set_preference('autogenerated_content', $data->autogeneratedcontent, true);
