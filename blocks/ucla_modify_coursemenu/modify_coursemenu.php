...
// Carry the previously viewed topic over and adjust it if it moves
...
$hide_autogenerated_content = $course_preferences->get_preference('hide_autogenerated_content');
...
if ($modify_coursemenu_form->is_cancelled()) {
    ...
    $course_preferences->set_preference('hide_autogenerated_content', $data->hideautogeneratedcontent, true);
