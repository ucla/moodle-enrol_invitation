...
//CCLE-2930:rearrange tool now shows correct sections by limitimg it with the course numsections.
$sections = array_slice(get_all_sections($course_id),0,$course->numsections+1);
