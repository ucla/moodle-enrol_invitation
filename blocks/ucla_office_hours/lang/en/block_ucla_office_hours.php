...
$string['f_email'] = 'E-mail address';
$string['f_website'] = 'Website';
$string['emptyfield'] = 'One or more required fields were left empty.';
$string['header'] = 'Update Office Hours and Contact Info';
$string['edituser'] = 'Updating information for: ';
$string['email_info'] = 'E-mail address';
$string['email_info_help'] = 
    'By default, the E-mail address displayed on the course web page is the 
    E-mail address taken from the UCLA-registrar. 
    If you would like to set a class specific E-mail address, you can do that here.
