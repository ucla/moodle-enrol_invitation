...
// Heading
echo $OUTPUT->heading(get_string('all_by_course_div', 'tool_uclacopyrightstatusreports'), 2, 'headingblock');
...
$list = get_copyright_list_by_division(&$filter_array);
