...
$string['moodlevideofurnacelist'] = 'Video-Furnace List: get_config(\'block_ucla_video_furnace\', \'source_url\')';
$string['moodlelibraryreserveslist'] = 'Library Reserves List: get_config(\'block_ucla_library_reserves\', \'source_url\')';
$string['moodlebruincastlist'] = 'Bruincast List: $CFG->bruincast_data';
