...
/**
 * English strings for UCLA role report
 *
 * @package    tool
...
$string['reducedediting'] = 'Reduced permissions';
$string['studentequiv'] = 'Participate only';
$string['guestequiv'] = 'View only';
$string['secondaryaddon'] = 'Secondary/Add-on';
$string['moodle_core'] = 'Core Moodle';
