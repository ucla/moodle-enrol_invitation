...
function update_videofurnace_db($datasource_url) {
    ...
    $mail_data = array();
    $num_incoming_data = sizeof($incoming_data);
    for ($row = 2; $row < $num_incoming_data; $row++) {
 ...
 * 
 * @param string $date_in   date in format of 6/20/12
 * @return int      int(10) unix timestamp 
 */
