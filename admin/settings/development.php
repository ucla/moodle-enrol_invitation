...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    /**
     * Public/private related settings.
     *
     *   - enablegroupmembersonly   Must be enabled for public/private.
     *                              Cannot disable when public/private enabled.
     *   - enablepublicprivate      Requires enablegroupmembersonly enabled.
     *                              Turns on all public/private functionality.
     *
     * @author ebollens
     * @version 20110719
     */
