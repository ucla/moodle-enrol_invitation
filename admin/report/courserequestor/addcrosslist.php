            ...
            <fieldset class="crqformodd">
                ...
                <label>
                    ...
                    <div class="crqfrmcrosslist">
                        ...
                        $crs = get_recordset_sql("select srs,course from mdl_ucla_request_classes where term like '$term' and action like '%uild' and (status = 'processing' or status = 'pending') order by course");
