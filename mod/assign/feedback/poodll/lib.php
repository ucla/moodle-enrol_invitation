...
/**
 * This file contains the moodle hooks for the PoodLL feedback plugin
 *
 ...
 */
function assignfeedback_poodll_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    global $USER, $DB;
