...
class mod_voicepodcaster_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $mform->addElement('select', 'resource', get_string('voicepodcastertype', 'voicepodcaster'), $resopts, array('onchange' => 'LoadNewFeaturePopup(this.options[this.selectedIndex].value);isValidate();'));
