...
$activities = $DB->count_records("voiceauthoring", array("course" => $course->id));
$blocks = $DB->count_records("block_instances", array('blockname' => 'bvoicerecorder'));

$PAGE->set_url(new moodle_url('/mod/voiceauthoring/index.php', array('id'=>$course->id)));
...
<div class="content general_font" id=content style="height:400px;width:700px;background-color:white;margin:0 auto;border: solid 1px #D9DEE5;" align=center>
    <div class="headerBar">
    ...
    <div id="activity" style="height:220px;width:700px;margin-top: 120px;" align="center">
        <span class="TextRegular" style="display:block;height:60px;width:700px;text-align:center">
            <?php echo get_string("you_have",'voiceauthoring')." ".$activities." ".get_string("vaActivities","voiceauthoring"); ?>
        </span>
        <span class="TextRegular" style="display:block; height:60px; width:700px; text-align:center">
            <?php echo get_string("you_have",'voiceauthoring')." ".$blocks." ".get_string("vaBlocks","voiceauthoring"); ?>
        </span>
        <span class="TextRegular" style="display:block;height:40px;width:700px;text-align:center">
            <?php echo get_string("ManageToolsNotAvailableStart","voiceauthoring"); ?>
        </span>
    </div>
