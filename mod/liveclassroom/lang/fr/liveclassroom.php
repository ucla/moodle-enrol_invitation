...
$string['serverconfiguration'] = 'Configuration du Serveur Live Classroom';
$string['explainserverconfiguration'] = 'Voici la configuration du serveur Live Classroom.';
...
$string['configsettinguniqueid'] = 'Un prefix unique destin&eacute; &agrave; permettre plusieurs instance de Moodle de partager un Serveur Live Classroom sans probl&egrave;me.';
$string['lcversion'] = 'Version du Serveur Live Classroom';
...
//Add activity form
$string['name'] = 'Nom';
$string['liveclassroomtype'] = 'Live Classroom Associ&eacute;e';
...
$string['lcpopupshouldappear.1'] = 'La Live Classroom devrait maintenant appara&icirc;tre.<br/> Dans le cas contraire, cliquez sur ';
...
$string['or'] = 'ou';
$string['new'] = 'Nouveau...';
$string["activity_manageTools"]="G&eacute;rer les Live Classrooms";
$string["activity_tools_not_available"]="La Live Classroom li&eacute;e &agrave; cette activit&eacute; est actuellement indisponible.<br>Merci de contacter votre professeur";
...
$string["activity_welcome_to_wimba"]="Bienvenue dans la Live Classroom!";

//calendar
$string['add_calendar']='Ajouter un &eacute;v&egrave;nement au calendrier';  
$string["launch_calendar"]="Lancer Live Classroom";      
...
$string['error_notfind'] = "Param&egrave;tres de Live Classroom invalides. Merci de contacter votre administrateur pour plus d'information.";
$string['error_room'] = "Param&egrave;tres de Live Classroom invalides. Merci de contacter votre administrateur pour plus d'information.";
...
$string['error_connection_lc'] = "Moodle ne peut se connecter au serveur de Live Classroom.. Merci de contacter votre administrateur pour plus d'information.";
...
$string['choiceElement_description_room'] = "Cr&eacute;er un nouveau Live Classroom";
...
$string['settings_enabled_guest_comment'] = "Note : Ce param&egrave;tre n'est effectif que lorsque l'acc&egrave;s public est activ&eacute; sur le serveur de Live Classroom .Veuillez contacter votre administrateur pour plus d'informations. ";
...
$string['settings_guest_access_comment'] = "Note : Ce param&egrave;tre n'est effectif que lorsque l'acc&egrave;s public est activ&eacute; sur le serveur de Live Classroom. Veuillez contacter votre administrateur pour plus d'informations.";
...
$string['configuration_lc'] = "Configuration du Serveur Live Classroom";
$string['configuration_lc_server_url'] = "URl du serveur Live Classroom:";
$string['configuration_lc_version'] = "Version du serveur Live Classroom:";
