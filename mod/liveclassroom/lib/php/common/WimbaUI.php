    ...
    */    
    function getVTPrincipalView($message,$type=null) {
        ...
        {//problem to get the vt resource
            ...
            $this->xml->setError(get_string("error_connection_vt", "liveclassroom"));
        }
...
* ***********************************/
    ...
    */ 
    function createVPInfoPanel() {
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('comment_slide', 'liveclassroom'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('private_slide', 'liveclassroom'));
        $this->xml->createLine();
    ...
    */     
    function createVBFeaturesPanel() {
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('short_message', 'liveclassroom'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('chrono_order', 'liveclassroom'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('show_forward', 'liveclassroom'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('settings_show_reply', 'liveclassroom'));
        ...
        if(isGradebookAvailable()){
          ...
          if(isset ($this->currentObject)){
            $activities = $DB->get_records("liveclassroom", array("rid" => $this->currentObject->getRid()));
            if(empty($activities)){
             $parameters['disabled'] = "true";
            }
          }else{
          ...
          $this->xml->addInputElement($parameters);
          $this->xml->addSimpleLineElement("label", get_string('grade_settings', 'liveclassroom'));
    ...
    */   
    function getListVoiceTools() {
        ...
        for ($i = 0; $i < count($ressources); $i++) 
        {
            ...
            $xmlResource->setTooltipAvailability(get_string("tooltipVT_" . $preview . "_student", 'liveclassroom'));
