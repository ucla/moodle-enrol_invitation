...
class mod_voicepresentation_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $mform->addElement('select', 'resource', get_string('voicepresentationtype', 'voicepresentation'), $resopts, array('onchange' => 'LoadNewFeaturePopup(this.options[this.selectedIndex].value);isValidate();'));
