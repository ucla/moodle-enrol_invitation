    ...
    */    
    function getVTPrincipalView($message,$type=null) {
        ...
        $this->xml->addButtonElement(
                        ...
                        "javascript:LaunchElement('manageAction.php','voicepresentation');");
        ...
        if($this->session->isInstructor())
        {
            $this->xml->addButtonElement(
                            ...
                            "doOpenAddActivity('../../course/mod.php','section=0&sesskey=" . sesskey() . "&add=voicepresentation')");
        ...
        {//problem to get the vt resource
            ...
            $this->xml->setError(get_string("error_connection_vt", "voicepresentation"));
        }
...
* ***********************************/
    ...
    */ 
    function createVPInfoPanel() {
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('comment_slide', 'voicepresentation'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('private_slide', 'voicepresentation'));
        $this->xml->createLine();
    ...
    */     
    function createVBFeaturesPanel() {
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('short_message', 'voicepresentation'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('chrono_order', 'voicepresentation'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('show_forward', 'voicepresentation'));
        ...
        $this->xml->addInputElement($parameters);
        $this->xml->addSimpleLineElement("label", get_string('settings_show_reply', 'voicepresentation'));
        ...
        if(isGradebookAvailable()){
          ...
          if(isset ($this->currentObject)){
            $activities = $DB->get_records("voicepresentation", array("rid" => $this->currentObject->getRid()));
            if(empty($activities)){
             $parameters['disabled'] = "true";
            }
          }else{
          ...
          $this->xml->addInputElement($parameters);
          $this->xml->addSimpleLineElement("label", get_string('grade_settings', 'voicepresentation'));
    ...
    */   
    function getListVoiceTools() {
        ...
        for ($i = 0; $i < count($ressources); $i++) 
        {
            ...
            $xmlResource->setTooltipAvailability(get_string("tooltipVT_" . $preview . "_student", 'voicepresentation'));
