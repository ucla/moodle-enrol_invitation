...
global $PAGE;
$PAGE->requires->js_module($CFG->wwwroot . '/mod/elluminate/testconnection.js');
...
$str = '<center><input type="button" onclick="return testConnection(document.getElementById(\'adminsettings\'), \''. $CFG->wwwroot . '\');" value="' .
